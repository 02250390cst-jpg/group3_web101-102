        ...
        <div className="space-y-6">
          <div className="inline-flex items-center gap-2 bg-white border border-gray-200 rounded-lg px-4 py-2 shadow-sm">
            ...
            <span className="text-xs font-medium text-gray-600">
              Customer Portal - Order Your Favorite Food
            </span>
          </div>
          ...
          <div>
            ...
            <p className="font-dm font-semibold text-sm tracking-[3px] text-gray-700 uppercase mt-1">
              Order Food Online & Get Delivered
            </p>
            <div className="w-24 h-[3px] bg-[#e85d04] rounded mt-3" />
          </div>

          <p className="text-gray-500 text-sm leading-relaxed max-w-md">
            Browse restaurants near you, explore delicious dishes, and place orders 
            in just a few clicks. Fast delivery and easy tracking.
          </p>

          {/* SIGN IN BUTTON WITH LINK - FIXED */}
<div className="flex flex-wrap gap-4">
  <Link href="/signin">
    <button className="flex items-center justify-center gap-2 bg-[#3d7a35] hover:bg-[#25a27] text-white font-semibold text-sm px-6 py-3 rounded-xl transition-all hover:scale-105 hover:shadow-lg min-w-[130px]">
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        <path d="M15 3h6v6M14 10L21 3M10 3H4v18h16v-4" stroke="currentColor" strokeLinecap="round"/>
        <path d="M16 13h4M18 11v4" stroke="currentColor" strokeLinecap="round"/>
      </svg>
      Sign In
    </button>
  </Link>
  <Link href="/signup">
    <button className="flex items-center justify-center gap-2 bg-[#3d7a35] hover:bg-[#2d5a27] text-white font-semibold text-sm px-6 py-3 rounded-xl transition-all hover:scale-105 hover:shadow-lg min-w-[130px]">
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        <path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2" stroke="currentColor" strokeLinecap="round"/>
        <circle cx="9" cy="7" r="4" stroke="currentColor"/>
        <path d="M19 11v6M22 14h-6" stroke="currentColor" strokeLinecap="round"/>
      </svg>
      Sign Up
    </button>
  </Link>
      ...
      <section className="max-w-6xl mx-auto px-8 py-10 flex items-center gap-6">
        ...
        <div className="text-center">
          <p className="text-xs tracking-widest text-gray-400 uppercase mb-1">Order Now</p>
